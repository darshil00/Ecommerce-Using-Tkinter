...
class main():
    def __init__(self,root):
        ...
        self.lst = [('Brand','OPPO'),
('Model',	'Reno5'),
('Dimensions (mm)'	,'159.1 x 73.4 x 7.9'),
('Weight (g)',	'172.00'),
('Battery capacity (mAh)',	'4300'),
('Fast charging'	,'Fast Charging 65W'),
('Colours ','Azure Blue, Starry Black'),
...
('Rear camera',	'64+8+2+2 megapixels'),
...
# columns in list
        ...
        self.Model="OPPO Reno5"
        self.Colour=["Azure Blue", "Starry Black"]
        self.Price=[21999,22999]
        self.Arial_font = tkFont.Font(family='Arial', size=14, weight='bold')
        ...
        self.img_1 = ImageTk.PhotoImage( Image.open("OppoReno5_1.png").resize((300, 500)))#width,height
        self.img_2=ImageTk.PhotoImage(Image.open("OppoReno5_2.png").resize((300, 500)))
        self.img_3=ImageTk.PhotoImage(Image.open("OppoReno5_3.png").resize((300, 500)))
        self.img_4=ImageTk.PhotoImage(Image.open("OppoReno5_4.png").resize((300, 500)))
        self.img_5=ImageTk.PhotoImage(Image.open("OppoReno5_5.png").resize((300, 500)))
    ...
    def init(self, a):
        ...
        self.e.place(relx=0.15, rely=0.05, relwidth=0.43,relheight=0.04)
        self.e = Label(a,font=('Arial',14,'bold'),bg="#A39E93",fg="#FAF9F7", text=self.lst[0][1], borderwidth=5, relief=GROOVE)
        self.e.place(relx=0.50, rely=0.05, relwidth=0.41,relheight=0.04)
        for i in range(1,self.total_rows):
            for j in range(self.total_columns):
                ...
                if j==0:
                    ...
                    self.e.place(relx=0.5, rely=self.count_y + 0.04, relwidth=0.41, relheight=0.04)
                    self.count_y+=0.04
