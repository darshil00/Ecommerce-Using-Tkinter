...
class main():
    def __init__(self,root):
        ...
        self.window.title("One Plus N10")
        ...
        self.Model = "One Plus N10"
        self.Colour = ["Midnight","Ice"]
        self.Price = [32000, 33000]
        self.Arial_font = tkFont.Font(family='Arial', size=14, weight='bold')
        ...
        self.img_1 = ImageTk.PhotoImage(Image.open("OnePlusN10_1.png").resize((300, 500)))  # width,height
        self.img_2 = ImageTk.PhotoImage(Image.open("OnePlusN10_2.png").resize((300, 500)))
        self.img_3 = ImageTk.PhotoImage(Image.open("OnePlusN10_3.png").resize((300, 500)))
        self.img_4 = ImageTk.PhotoImage(Image.open("OnePlusN10_4.png").resize((300, 500)))
        self.img_5 = ImageTk.PhotoImage(Image.open("OnePlusN10_5.png").resize((300, 500)))
