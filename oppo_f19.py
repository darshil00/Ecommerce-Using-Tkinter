...
class main():
    def __init__(self,root):
        ...
        self.lst = [('Brand','OPPO'),
('Model',	'f19'),
('Dimensions (mm)'	,'160.1 x 73.4 x 7.8'),
('Weight (g)',	'173.00'),
('Battery capacity (mAh)',	'4310'),
('Fast charging'	,'Fast Charging 50W'),
('Colours ','Fluid Black, Cosmo Blue'),
('Screen size (inches)', '6.43'),
('Resolution', '1080 x 2400 pixels'),
('Processor', 'octa-core'),
('Processor make', 'MediaTek Helio P95'),
('RAM', '8GB'),
...
('Pop-Up Camera',	'No')]
        ...
        self.Model = "OPPO f19"
        self.Colour = ["Fluid Black","Cosmo Blue"]
        self.Price = [19999, 20999]
        self.Arial_font = tkFont.Font(family='Arial', size=14, weight='bold')
        ...
        self.img_1 = ImageTk.PhotoImage( Image.open("Oppof19_1.png").resize((300, 500)))#width,height
        self.img_2=ImageTk.PhotoImage(Image.open("Oppof19_2.png").resize((300, 500)))
        self.img_3=ImageTk.PhotoImage(Image.open("Oppof19_3.png").resize((300, 500)))
        self.img_4=ImageTk.PhotoImage(Image.open("Oppof19_4.png").resize((300, 500)))
        self.img_5=ImageTk.PhotoImage(Image.open("Oppof19_5.png").resize((300, 500)))
