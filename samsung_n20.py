...
class main():
    def __init__(self,root):
        ...
        self.window.title("Samsung Note20 Ultra")
...
('Colours',	'Bronze, Mystic Black, White'),
...
('Pop-Up Camera',	'No')]
        ...
        self.Model = "Samsung Note20 Ultra"
        self.Colour = ["Bronze", "Mystic Black", "White"]
        self.Price = [104999, 105999, 106999]
        self.Arial_font = tkFont.Font(family='Arial', size=14, weight='bold')
        ...
        self.img_1 = ImageTk.PhotoImage( Image.open("SamsungNote_1.png").resize((300, 500)))#width,height
        self.img_2=ImageTk.PhotoImage(Image.open("SamsungNote_2.png").resize((300, 500)))
        self.img_3=ImageTk.PhotoImage(Image.open("SamsungNote_3.png").resize((300, 500)))
        self.img_4=ImageTk.PhotoImage(Image.open("SamsungNote_4.png").resize((300, 500)))
        self.img_5=ImageTk.PhotoImage(Image.open("SamsungNote_5.png").resize((300, 500)))
    ...
    def init(self, a):
        ...
        self.e.place(relx=0.50, rely=0.05, relwidth=0.42,relheight=0.04)
        for i in range(1,self.total_rows):
            for j in range(self.total_columns):
                ...
                if j==0:
                    ...
                    self.e.place(relx=0.5, rely=self.count_y + 0.04, relwidth=0.42, relheight=0.04)
                    self.count_y+=0.04
