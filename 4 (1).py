...
# columns in list
        ...
        self.img_1 = ImageTk.PhotoImage( Image.open("Janna.png").resize((300, 500)))#width,height
        self.img_2=ImageTk.PhotoImage(Image.open("Janna_2.png").resize((300, 500)))
        self.img_3=ImageTk.PhotoImage(Image.open("Janna_3.png").resize((300, 500)))
        self.img_4=ImageTk.PhotoImage(Image.open("Janna_4.png").resize((300, 500)))
        self.img_5=ImageTk.PhotoImage(Image.open("Janna_5.png").resize((300, 500)))
