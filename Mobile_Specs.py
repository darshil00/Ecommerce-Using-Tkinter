        ...
        for i in range(1,total_rows):
            for j in range(total_columns):
                ...
                if j==0:
                    ...
                    self.e = ttk.Label(a, font=("Arial", 14), text=lst[i][j], borderwidth=20, relief=GROOVE)
                    self.e.place(relx=0.89, rely=count_y+0.04, relheight=0.04)
                    count_y += 0.04
                #self.e.insert(END, lst[i][j])
# take the data
lst = [('Brand','Oppo','1'),
('Model',	'A74','1'),
('Dimensions (mm)'	,'160.30 x 73.80 x 7.95','1'),
('Weight (g)',	'175.00','1'),
('Battery capacity (mAh)',	'5000','1'),
('Fast charging'	,'Proprietary','1'),
('Colours	Midnight ',' Blue, Prism Black','1'),
       ('Screen size (inches)', '6.43','1'),
       ('Resolution', '1080x2400 pixels','1'),
       ('Processor', 'octa-core','1'),
       ('Processor make', 'Qualcomm Snapdragon 662','1'),
       ('RAM', '6GB','1'),
       ('Internal storage', '128GB','1'),
       ('Expandable storage', 'Yes','1'),
       ('Expandable storage type', 'microSD','1'),
('Rear camera',	'48-megapixel','1'),
('No. of Rear Cameras'	,'3','1'),
('Rear autofocus'	,'Yes','1'),
('Rear flash'	,'Yes','1'),
('Front camera',	'16-megapixel','1'),
...
button_cart=Button(frame_bottom,text="Back to main Menu",command=win.quit,image=img_menu)
