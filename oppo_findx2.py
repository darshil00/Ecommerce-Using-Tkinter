...
class main():
    def __init__(self,root):
        ...
        self.window.title("OPPO Find X2")
        ...
        self.lst= [('Brand','OPPO'),
('Model',	'Find X2'),
('Dimensions (mm)'	,'164.90 x 74.50 x 8.00'),
('Weight (g)',	'187.00'),
...
('Rear camera',	'48+12+13 megapixels'),
...
# columns in list
        ...
        self.Model="OPPO Find X2"
        self.Colour=["Black","Ocean"]
        self.Price=[40999,41999]
        self.Arial_font = tkFont.Font(family='Arial', size=14, weight='bold')
        ...
        self.img_1 = ImageTk.PhotoImage( Image.open("OppoFindX2_1.png").resize((300, 500)))#width,height
        self.img_2=ImageTk.PhotoImage(Image.open("OppoFindX2_2.png").resize((300, 500)))
        self.img_3=ImageTk.PhotoImage(Image.open("OppoFindX2_3.png").resize((300, 500)))
        self.img_4=ImageTk.PhotoImage(Image.open("OppoFindX2_4.png").resize((300, 500)))
        self.img_5=ImageTk.PhotoImage(Image.open("OppoFindX2_5.png").resize((300, 500)))
