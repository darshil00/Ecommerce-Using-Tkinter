...
img_1 = ImageTk.PhotoImage( Image.open("OppoFindX2_1.png").resize((300, 500)))#width,height
img_2=ImageTk.PhotoImage(Image.open("OppoFindX2_2.png").resize((300, 500)))
img_3=ImageTk.PhotoImage(Image.open("OppoFindX2_3.png").resize((300, 500)))
img_4=ImageTk.PhotoImage(Image.open("OppoFindX2_4.png").resize((300, 500)))
img_5=ImageTk.PhotoImage(Image.open("OppoFindX2_5.png").resize((300, 500)))
