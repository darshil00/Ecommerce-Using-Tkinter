...
class main():
    def __init__(self,root):
        ...
        ('Model',   'M31'),
        ('Dimensions (mm)'	,'159.2 x 75.1 x 8.9 '),
        ('Weight (g)',	'191.00'),
        ('Battery capacity (mAh)',	'6000'),
        ('Fast charging'	,'Proprietary'),
        ('Colours',	'Midnight, Ocean Blue, Space Black'),
        ('Screen size (inches)', '6.43'),
        ('Resolution', '1080x2340 pixels'),
        ('Processor', 'octa-core'),
        ('Processor make', 'Mali-G72 MP3'),
        ('RAM', '8GB'),
        ...
        self.Model= "Samsung M31"
        self.Colour=["Midnight", "Ocean Blue", "Space Black"]
        self.Price=[16999,17999,18999]
        self.Arial_font = tkFont.Font(family='Arial', size=14, weight='bold')
        ...
        self.img_1 = ImageTk.PhotoImage( Image.open("SamsungM31_1.png").resize((300, 500)))#width,height
        self.img_2=ImageTk.PhotoImage(Image.open("SamsungM31_2.png").resize((300, 500)))
        self.img_3=ImageTk.PhotoImage(Image.open("SamsungM31_3.png").resize((300, 500)))
        self.img_4=ImageTk.PhotoImage(Image.open("SamsungM31_4.png").resize((300, 500)))
        self.img_5=ImageTk.PhotoImage(Image.open("SamsungM31_5.png").resize((300, 500)))
        ...
        for i in range(1,self.total_rows):
            for j in range(self.total_columns):
                '''self.e = Entry(a, width=20, fg='blue',
                               font=('Arial', 16, 'bold'))'''
                if j==0:
                    self.e = Label(a,font=('Arial',14,'bold'),bg="#A39E93",fg="#FAF9F7",anchor=W, text=self.lst[i][j], borderwidth=5, relief=GROOVE)
