...
class main():
    def __init__(self, root):
        ...
        self.lst = [('Brand', 'Apple'),
                    ...
                    ('Fast charging', 'Fast charging 20W'),
        ...
        self.Colour = ["Blue", "Green", "Purple"]
        self.Price = [70900, 71900, 72900]
        self.Arial_font = tkFont.Font(family='Arial', size=14, weight='bold')
        ...
        self.img_1 = ImageTk.PhotoImage(Image.open("Iphone12_1.png").resize((300, 500)))  # width,height
        self.img_2 = ImageTk.PhotoImage(Image.open("Iphone12_2.png").resize((300, 500)))
        self.img_3 = ImageTk.PhotoImage(Image.open("Iphone12_3.png").resize((300, 500)))
        self.img_4 = ImageTk.PhotoImage(Image.open("Iphone12_4.png").resize((300, 500)))
        self.img_5 = ImageTk.PhotoImage(Image.open("Iphone12_5.png").resize((300, 500)))
