...
class main():
    def __init__(self,root):
        ...
        self.lst = [('Brand','OPPO'),
('Model',	'A55'),
('Dimensions (mm)'	,'163.6 x 75.7 x 8.4'),
('Weight (g)',	'193.00'),
('Battery capacity (mAh)',	'4310'),
('Fast charging'	,'Fast Charging 18W'),
('Colours ','Starry Black, Green'),
...
('Pop-Up Camera',	'No')]
        ...
        self.Model = "OPPO A55"
        self.Colour = ["Starry Black","Green"]
        self.Price = [15999,16999]
        self.Arial_font = tkFont.Font(family='Arial', size=14, weight='bold')
        ...
        self.img_1 = ImageTk.PhotoImage(Image.open("OppoA55_1.png").resize((300, 500)))  # width,height
        self.img_2 = ImageTk.PhotoImage(Image.open("OppoA55_2.png").resize((300, 500)))
        self.img_3 = ImageTk.PhotoImage(Image.open("OppoA55_3.png").resize((300, 500)))
        self.img_4 = ImageTk.PhotoImage(Image.open("OppoA55_4.png").resize((300, 500)))
        self.img_5 = ImageTk.PhotoImage(Image.open("OppoA55_5.png").resize((300, 500)))
