...
('Model',	'9'),
('Dimensions (mm)'	,'160 x 73.9 x 8.1'),
('Weight (g)',	'183.00'),
...
('Pop-Up Camera',	'No')]
        ...
        self.Model = "Oneplus 9"
        self.Colour = ["Blue","Black","Grey"]
        self.Price = [51999, 52999, 53999]
        ...
        self.img_1 = ImageTk.PhotoImage(Image.open("OnePlus9_1.png").resize((300, 500)))  # width,height
        self.img_2 = ImageTk.PhotoImage(Image.open("OnePlus9_2.png").resize((300, 500)))
        self.img_3 = ImageTk.PhotoImage(Image.open("OnePlus9_3.png").resize((300, 500)))
        self.img_4 = ImageTk.PhotoImage(Image.open("OnePlus9_4.png").resize((300, 500)))
        self.img_5 = ImageTk.PhotoImage(Image.open("OnePlus9_5.png").resize((300, 500)))
