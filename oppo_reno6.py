...
class main():
    def __init__(self,root):
        ...
        self.lst = [('Brand','OPPO'),
('Model',	'Reno6'),
('Dimensions (mm)'	,'156.8 x 72.1 x 7.6'),
('Weight (g)',	'182.00'),
('Battery capacity (mAh)',	'4300'),
('Fast charging'	,'Fast Charging 65W'),
('Colours ','Blue, Aurora, Purple'),
('Screen size (inches)', '6.43'),
('Resolution', '1080 x 2400 pixels'),
('Processor', 'octa-core'),
('Processor make', 'MediaTek Dimensity 1000+'),
('RAM', '8GB'),
...
# columns in list
        ...
        self.Model="OPPO Reno6"
        self.Colour=["Blue","Aurora","Purple"]
        self.Price=[28999,29999,30999]
        self.Arial_font = tkFont.Font(family='Arial', size=14, weight='bold')
        ...
        self.img_1 = ImageTk.PhotoImage( Image.open("OppoReno6_1.png").resize((300, 500)))#width,height
        self.img_2=ImageTk.PhotoImage(Image.open("OppoReno6_2.png").resize((300, 500)))
        self.img_3=ImageTk.PhotoImage(Image.open("OppoReno6_3.png").resize((300, 500)))
        self.img_4=ImageTk.PhotoImage(Image.open("OppoReno6_4.png").resize((300, 500)))
        self.img_5=ImageTk.PhotoImage(Image.open("OppoReno6_5.png").resize((300, 500)))
