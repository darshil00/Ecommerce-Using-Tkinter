...
class main():
    def __init__(self,root):
        ...
        ('Model',      'S21'),
        ('Dimensions (mm)'	,'151.7 x 71.2 x 7.9'),
        ('Weight (g)',	'169.00'),
        ('Battery capacity (mAh)',	'4000'),
        ('Fast charging'	,'Proprietary'),
        ('Colours',	'Phantom White, Violet, Pink'),
        ...
        self.Model="Samsung S21"
        self.Colour=["Phantom White", "Violet", "Pink"]
        self.Price=[54999,55999,56999]
        self.Arial_font = tkFont.Font(family='Arial', size=14, weight='bold')
        ...
        self.img_1 = ImageTk.PhotoImage( Image.open("SamsungS21_1.png").resize((300, 500)))#width,height
        self.img_2=ImageTk.PhotoImage(Image.open("SamsungS21_2.png").resize((300, 500)))
        self.img_3=ImageTk.PhotoImage(Image.open("SamsungS21_3.png").resize((300, 500)))
        self.img_4=ImageTk.PhotoImage(Image.open("SamsungS21_4.png").resize((300, 500)))
        self.img_5=ImageTk.PhotoImage(Image.open("SamsungS21_5.png").resize((300, 500)))
