...
class main():
    def __init__(self, root):
        ...
        self.lst =[('Brand','Oneplus'),
('Model',	'9R'),
('Dimensions (mm)'	,'161 x 74.1 x 8.4'),
('Weight (g)',	'189.00'),
('Battery capacity (mAh)',	'4500'),
('Fast charging'	,'Proprietary'),
('Colours',	'Midnight, Carbon Black, Lake Blue'),
...
# columns in list
        ...
        self.Model = "Oneplus 9R"
        self.Colour = ["Midnight","Carbon Black","Lake Blue"]
        self.Price = [39999,40999, 41999]

        self.Arial_font = tkFont.Font(family='Arial', size=14, weight='bold')
        self.options = StringVar(self.window)
        self.options.set("Colour[0]")
        ...
        self.img_1 = ImageTk.PhotoImage(Image.open("OnePlus9R_1.png").resize((300, 500)))  # width,height
        self.img_2 = ImageTk.PhotoImage(Image.open("OnePlus9R_2.png").resize((300, 500)))
        self.img_3 = ImageTk.PhotoImage(Image.open("OnePlus9R_3.png").resize((300, 500)))
        self.img_4 = ImageTk.PhotoImage(Image.open("OnePlus9R_4.png").resize((300, 500)))
        self.img_5 = ImageTk.PhotoImage(Image.open("OnePlus9R_5.png").resize((300, 500)))

        self.image_list = [self.img_1, self.img_2, self.img_3
                           , self.img_4, self.img_5]
    ...
    def init(self, a):
        ...
        self.e.place(relx=0.50, rely=0.05, relwidth=0.45,relheight=0.04)
        for i in range(1,self.total_rows):
            for j in range(self.total_columns):
                ...
                if j==0:
                    ...
                    self.e.place(relx=0.5, rely=self.count_y + 0.04, relwidth=0.45, relheight=0.04)
                    self.count_y+=0.04
...
def class_call(root_cariable):
    t=main(root_cariable)
