...
class main():
    def __init__(self,root):
        ...
        self.window.title("IPHONE 13 Pro")
        ...
        self.lst = [('Brand','Apple'),
                    ...
                    ('Fast charging'	,'Fast charging 23W'),
                    ('Colours ','Sierra Blue, Silver, Gold'),
        ...
        self.Colour = ["Sierra Blue","Silver","Gold"]
        self.Price = [149999, 150999, 151999]
        self.Arial_font = tkFont.Font(family='Arial', size=14, weight='bold')
        ...
        self.img_1 = ImageTk.PhotoImage(Image.open("Iphone13Pro_1.png").resize((300, 500)))  # width,height
        self.img_2 = ImageTk.PhotoImage(Image.open("Iphone13Pro_2.png").resize((300, 500)))
        self.img_3 = ImageTk.PhotoImage(Image.open("Iphone13Pro_3.png").resize((300, 500)))
        self.img_4 = ImageTk.PhotoImage(Image.open("Iphone13Pro_4.png").resize((300, 500)))
        self.img_5 = ImageTk.PhotoImage(Image.open("Iphone13Pro_5.png").resize((300, 500)))
