...
class main():
    def __init__(self,root):
        ...
        self.lst = [('Brand', 'Apple'),
               ('Model', 'Iphone 11'),
               ('Dimensions (mm)', '150.9 x 75.7 x 8.3 agsdjkagdkajdgajkga'),
               ('Weight (g)', '194.00'),
        ...
        self.Colour = ["Green1", "Red2", "Yellow3"]
    ...
    def init(self, a):
        ...
        self.e = Label(a,font=('Arial',14,'bold'),bg="#A39E93",fg="#FAF9F7", text=self.lst[0][0],anchor=W, borderwidth=5, relief=GROOVE)
