...
class main():
    def __init__(self,root):
        ...
        self.Colour = ["Blue","Pink","Red"]
        self.Price =  [70999,71999,72999]
        self.Arial_font = tkFont.Font(family='Arial', size=14, weight='bold')
        ...
        self.img_1 = ImageTk.PhotoImage(Image.open("Iphone13_1.png").resize((300, 500)))  # width,height
        self.img_2 = ImageTk.PhotoImage(Image.open("Iphone13_2.png").resize((300, 500)))
        self.img_3 = ImageTk.PhotoImage(Image.open("Iphone13_3.png").resize((300, 500)))
        self.img_4 = ImageTk.PhotoImage(Image.open("Iphone13_4.png").resize((300, 500)))
        self.img_5 = ImageTk.PhotoImage(Image.open("Iphone13_5.png").resize((300, 500)))
