...
class main():
    def __init__(self,root):
        ...
        self.Model = "Iphone SE"
        self.Colour = ["White","Black","Red"]
        self.Price = [30999, 31999, 32999]
        self.Arial_font = tkFont.Font(family='Arial', size=14, weight='bold')
        ...
        self.iimg_1 = ImageTk.PhotoImage( Image.open("IphoneSE_1.png").resize((300, 500)))#width,height
        self.img_2=ImageTk.PhotoImage(Image.open("IphoneSE_2.png").resize((300, 500)))
        self.img_3=ImageTk.PhotoImage(Image.open("IphoneSE_3.png").resize((300, 500)))
        self.img_4=ImageTk.PhotoImage(Image.open("IphoneSE_4.png").resize((300, 500)))
        self.img_5=ImageTk.PhotoImage(Image.open("IphoneSE_5.png").resize((300, 500)))
