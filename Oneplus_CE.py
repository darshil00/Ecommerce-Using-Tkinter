...
class main():
    def __init__(self,root):
        ...
        self.window.title("Oneplus Nord CE")
...
# columns in list
        ...
        self.Model = "Oneplus Nord CE"
        self.Colour = ["Winter Mist", "Arctic Sky", "Astral Black"]
        self.Price = [24999, 25999, 26999]
        self.Arial_font = tkFont.Font(family='Arial', size=14, weight='bold')
        ...
        self.img_1 = ImageTk.PhotoImage(Image.open("OnePlusCE_1.png").resize((300, 500)))  # width,height
        self.img_2 = ImageTk.PhotoImage(Image.open("OnePlusCE_2.png").resize((300, 500)))
        self.img_3 = ImageTk.PhotoImage(Image.open("OnePlusCE_3.png").resize((300, 500)))
        self.img_4 = ImageTk.PhotoImage(Image.open("OnePlusCE_4.png").resize((300, 500)))
        self.img_5 = ImageTk.PhotoImage(Image.open("OnePlusCE_5.png").resize((300, 500)))
    ...
    def init(self, a):
        ...
        self.e.place(relx=0.50, rely=0.05, relwidth=0.46,relheight=0.04)
        for i in range(1,self.total_rows):
            for j in range(self.total_columns):
                ...
                if j==0:
                    ...
                    self.e.place(relx=0.5, rely=self.count_y + 0.04, relwidth=0.46, relheight=0.04)
                    self.count_y+=0.04
