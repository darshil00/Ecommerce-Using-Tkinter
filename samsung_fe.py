...
class main():
    def __init__(self,root):
        ...
        self.window.title("Samsung S20 FE")
...
('Colours',	'Lavender, Cloud Mint, Cloud Navy'),
...
# columns in list
        ...
        self.Model="Samsung S20 FE"
        self.Colour=["Lavender", "Cloud Mint", "Cloud Navy"]
        self.Price=[40999,41999,42999]#wrong price
        ...
        self.img_1=ImageTk.PhotoImage(Image.open("SamsungFE_1.png").resize((300, 500)))#width,height
        self.img_2=ImageTk.PhotoImage(Image.open("SamsungFE_2.png").resize((300, 500)))
        self.img_3=ImageTk.PhotoImage(Image.open("SamsungFE_3.png").resize((300, 500)))
        self.img_4=ImageTk.PhotoImage(Image.open("SamsungFE_4.png").resize((300, 500)))
        self.img_5=ImageTk.PhotoImage(Image.open("SamsungFE_5.png").resize((300, 500)))
    ...
    def init(self, a):
        ...
        self.e.place(relx=0.50, rely=0.05, relwidth=0.5,relheight=0.04)
        for i in range(1,self.total_rows):
            for j in range(self.total_columns):
                ...
                if j==0:
                    ...
                    self.e.place(relx=0.5, rely=self.count_y + 0.04, relwidth=0.5, relheight=0.04)
                    self.count_y+=0.04
